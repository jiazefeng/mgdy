...
<div class="main-content">
                ...
                <form id="form" class="form-horizontal" action="../news/getNewsList.html">
                    ...
                    <div class="form-group  col-lg-12">
                        ...
                        <div class="col-sm-5">
                            ...
                            <a href="../user/toAddTeam.html" class="btn btn-primary">新增</a>
                        </div>
    ...
    <div class="table-responsive bs-example widget-shadow">
        <table width="100%" class="tableStyle">
            ...
            <tbody>
            <c:forEach items="${teamInfoList}" var="team" varStatus="row">
                <tr>
                    <td><b>${(webPage.pageIndex-1)*20+row.index + 1}</b></td>
                    <td>${team.teamName}</td>
                    <td>${team.teamTitle}</td>
                    <td class="last">
                        <a href="javascript:void(0);" onclick="toEdit('${team.teamId}')" id="toEdit" class="a3">编辑</a>
                        <a href="javascript:void(0);" onclick="toDelete('${team.teamId}')" id="toDelete"
                           class="a3">删除</a>
                    </td>
                </tr>
            </c:forEach>
        ...
        <m:pager pageIndex="${webPage.pageIndex}"
                 ...
                 submitUrl="${pageContext.request.contextPath }/user/getTeamList.html?pageIndex={0}"/>
    </div>
...
<script>
    //新增与修改
    function toEdit(id) {
        window.location.href = "../user/searchTeamById?teamId=" + id;
    }
    //删除
    function toDelete(id) {
        if (confirm("确定要删除吗?")) {
            window.location.href = "../user/deleteTeamInfo?teamId=" + id;
        }
    }
</script>
</body>
