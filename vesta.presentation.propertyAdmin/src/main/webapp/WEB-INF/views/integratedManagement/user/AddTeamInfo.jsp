...
<div class="main-content">
    ...
    <div class="forms">
        <div class="widget-shadow " data-example-id="basic-forms">
            <div class="form-body">
                <h3 class="text-center">添加团队信息</h3>
                <div class="form-body" style="min-height:380px">
                    <form class="form-horizontal" id="form" action="../user/saveTeamInfo" method="post"
                        ...
                        <div class="form-group col-lg-9">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="teamTitle" class="form-control" name="teamTitle">
                            </div>
                        </div>
                        <%-- 首页展示图 --%>
                        <div class="form-group col-lg-9">
                        ...
                        <div class="form-group col-lg-9">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="teamDescribe" name="teamDescribe"></textarea>
                            </div>
                        </div>
