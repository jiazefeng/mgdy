...
<div class="main-content">
    ...
    <div class="forms">
        <div class="widget-shadow " data-example-id="basic-forms">
            <div class="form-body">
                <h3 class="text-center">编辑游客信息</h3>
                <div class="form-body" style="min-height:380px">
                    <form class="form-horizontal" id="form" action="../user/updateTouristInfo" method="post"
                          enctype="MULTIPART/FORM-DATA">
                        <input type="hidden" name="touristId" value="${touristInfo.touristId}">
                        <div class="form-group col-lg-9">
                            <label class="col-sm-2 control-label" for="touristName">名称</label>
                            <div class="col-sm-9">
                                <input type="text" id="touristName" class="form-control" name="touristName"
                                       value="${touristInfo.touristName}">
                            </div>
                        </div>
                        <%-- 首页展示图 --%>
                        <div class="form-group col-lg-9">
                            ...
                            <div class="col-sm-9">
                                <input id="touristPageimgFile" name="touristPageimgFile" type="file" multiple/>
                                <p style="color: red">
                                    <span>您将上传首页展示图，建议宽高比为700x400！</span>
                                </p>
                                <div class="col-lg-3" style="margin-top: 5px">
                                    <img src="${touristInfo.touristImageUrl}" alt="" class="img-thumbnail"
                                         style="width: auto">
                                </div>
                            </div>
                        </div>
                        ...
                        <a href="../user/getTouristList.html" class="btn btn-primary">取消</a>
                    </form>
                </div>
            </div>
        </div>
...
<script>
    $(function () {
        initFileInput("touristPageimgFile", "");
    });
