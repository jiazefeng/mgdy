...
<div class="main-content">
    ...
    <div class="table-responsive bs-example widget-shadow">
        ...
        <table width="100%" class="tableStyle">
            ...
            <c:forEach items="${roleMenuDTOs}" var="menu" varStatus="vs">
                <tr>
                    ...
                    <td class="last">
                        <a href="../menu/menuSecManage?parId=${menu.roleMenuId}" class="a3"><span
                                class="span1">管理二级菜单</span></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
        ...
        <m:pager pageIndex="${webPage.pageIndex}"
                 ...
                 submitUrl="${pageContext.request.contextPath }/menu/menuManage.html?pageIndex={0}"/>
    </div>
        ...
        <div class="modal-dialog" style="text-align: -webkit-center">
            <div class="modal-content" style="width: 65%">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel1">添加一级菜单</h4>
                </div>
...
<script>
    ...
    function saveMenu() {
        ...
        window.location.href = "../menu/addFirMenu?roleMenuName=" + roleMenuName + "&roleMenuDesc=" + roleMenuDesc;
    }
</script>
</body>
</html>