...
<div class="main-content">
    ...
    <div class="forms">
        <div class="widget-shadow " data-example-id="basic-forms">
            <div class="form-body">
                <h3 class="text-center">添加房间信息</h3>
                <div class="form-body" style="min-height:380px">
                    <form class="form-horizontal" id="form" action="../house/saveHouseInfo" method="post"
                        ...
                        <div class="form-group  col-lg-9">
                            ...
                            <div class="col-sm-9">
                                <select id="houseType" name="houseType" class="form-control">
                                    <option value="LUCURY">五星级/豪华</option>
                                    <option value="HIGH_GRADE">四星级/高档</option>
                                    <option value="COMFORTABLE">三星级/舒适</option>
                                    <option value="ECONOMICS">二星级及以下/经济</option>
                                </select>
                            </div>
                        </div>
                        <%--房屋价格--%>
                        ...
                        <div class="form-group col-lg-9">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="houseDescribe" name="houseDescribe"></textarea>
                            </div>
                        </div>
                        <%-- 户型展示图 --%>
                        <div class="form-group col-lg-9">
