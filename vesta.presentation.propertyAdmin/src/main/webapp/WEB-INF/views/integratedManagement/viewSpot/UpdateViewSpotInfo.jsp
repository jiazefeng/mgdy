        ...
        <div class="widget-shadow " data-example-id="basic-forms">
            <div class="form-body">
                ...
                <div class="form-body" style="min-height:380px">
                    <form class="form-horizontal" id="form" action="../viewSpot/updateViewSpotInfo" method="post"
                          enctype="MULTIPART/FORM-DATA">
                        <input type="hidden" name="viewSpotId" value="${viewSpotInfo.viewSpotId}">
                        <%--分类--%>
                        <div class="form-group  col-lg-9">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" placeholder="" id="classify" name="classify">
                                    <option value="1"  <c:if test="${viewSpotInfo.classify eq '1'}">selected</c:if>>风景</option>
                                    <option value="2"  <c:if test="${viewSpotInfo.classify eq '2'}">selected</c:if>>美食</option>
                                    <option value="3"  <c:if test="${viewSpotInfo.classify eq '3'}">selected</c:if>>娱乐</option>
                                </select>
                            </div>
                        </div>
                        <%--标题--%>
                        <div class="form-group col-lg-9">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="viewSpotTitle" name="viewSpotTitle" class="form-control"
                                       value="${viewSpotInfo.viewSpotTitle}">
                            </div>
                        </div>
                        <%-- 首页展示图 --%>
                        <div class="form-group col-lg-9">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="col-lg-3" style="margin-top: 5px">
                                    <img src="${viewSpotInfo.viewSpotImageUrl}" alt="" class="img-thumbnail"
                                         style="width: auto">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-lg-9">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="viewSpotDescribe"
                                          name="viewSpotDescribe">${viewSpotInfo.viewSpotDescribe}</textarea>
                            </div>
                        </div>
                        <div class="form-group col-lg-9">
