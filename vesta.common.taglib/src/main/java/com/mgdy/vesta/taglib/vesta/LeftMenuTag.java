package com.mgdy.vesta.taglib.vesta;
...
//            str.append("<li><a href='#'><i class='fa ");
            str.append("<li><a href='#'><span class='");
            //拼接标签样式
            String leftIcon = getLeftIcon(tmpmodel.getMenuId());

            str.append(leftIcon);
//            str.append(" nav_icon' aria-hidden='true'></i>" + tmpmodel.getMenuName());
            str.append("  ' aria-hidden='true' style='padding-right: 8px;'></span>" + tmpmodel.getMenuName());
//补充二级
...
//        if(str1.length() > 0){
//            outWrapStr.append("<li id='vip'>蒙古大营</li>");
//        }
//        if(str2.length() > 0){
//            outWrapStr.append("<li id='quality'>工程质量</li>");
//        }
//        if(str3.length() > 0){
//            outWrapStr.append("<li id='inspection'>交房验房</li>");
//        }
//        if(str4.length() > 0){
//            outWrapStr.append("<li id='operate'>报修管理</li>");
//        }
//        if(str5.length() > 0){
